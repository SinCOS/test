                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <input type="number" class="form-control" placeholder="填写纯数字" name="jkje" value="" required="required" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <input type="number" class="form-control" placeholder="填写纯数字" name="jkqx" value="" required="required" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <select class="form-control" name="dyxx">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <select class="form-control" name="hkfs">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <textarea name="jkms" placeholder="借款描述" class="form-control" style="height:100px;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <select class="form-control" name="hyzk">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <select class="form-control" name="zgxl">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <input type="text" class="form-control" placeholder="现居住地址" name="address" value="" required="required" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <input type="number" class="form-control" placeholder="填写纯数字" name="yjsr" value="" required="required" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <input type="number" class="form-control" placeholder="填写纯数字" name="njsr" value="" required="required" >
                        </div>
                    </div>
