...
<div class="laymain">
    ...
    <div class="au_top">
        ...
        <div class="au_t_po">
            ...
            <ul>
                ...
                <li><span class="s1">{{$user->name}}<img src="/app/images/k_01.png"></span><span>当前等级:{{ $user->vip == 1 ? '超级会员' : '普通会员' }}</span></li>
            </ul>
        </div>
    </div>
    <!--top-->
    ...
    <div class="au_txt">
        <ul>
            ...
            <li>
                <span>点击进入信息编辑页面补充个人资料，所填信息务必确保真实性，以便审核员复核个人信息。</span><a href="">我要借款</a>
            </li>
